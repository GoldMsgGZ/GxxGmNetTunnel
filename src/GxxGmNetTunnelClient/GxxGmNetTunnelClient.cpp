...
int main(int argc, const char *argv[])
{
	...
	GxxGmTunnelServer *server = new GxxGmTunnelServer();
	int errCode = server->Initialize(tcp_ip, t_port, tunnel_cli_ip, t_cli_port, tunnel_cli_id, tunnel_srv_ip, t_srv_port, tunnel_srv_id);
	if (errCode != 0)
	{
